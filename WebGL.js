...
function calculations(){
	...
	if(tz_cars < 0){
		...
		tz_cars = -14;
		tx_carLeft1 = (Math.random() * (0.32 + 0.32) - 0.32).toFixed(4);
		tx_carRight1 = (Math.random() * (0.32 + 0.32) - 0.32).toFixed(4);
		tx_carLeft2 = (Math.random() * (0.32 + 0.32) - 0.32).toFixed(4);
		tx_carRight2 = (Math.random() * (0.32 + 0.32) - 0.32).toFixed(4);
	}
...
function drawScene() {
	tzCar2 = tz_cars + (tx_carRight2*2); //red up
	tzCar1 = tz_cars + 1 + (tx_carLeft1*2);	//yellow up
	tzCar3 = tz_cars + 3 + (tx_carLeft2*2); //red bellow
	tzCar4 = tz_cars + 4.5 + (tx_carRight2*2); //yellow bellow
